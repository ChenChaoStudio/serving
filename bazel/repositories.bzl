...
def _com_aws_sdk():
    maybe(
        http_archive,
        name = "com_aws_sdk",
        sha256 = "306df858664f86c08dce9d758503c79e1f3fdbd8e9e805ee9abbaae17ab36803",
        strip_prefix = "aws-sdk-cpp-1.11.415",
        build_file = "@sf_serving//bazel:aws.BUILD",
        urls = [
            "https://github.com/aws/aws-sdk-cpp/archive/1.11.415.tar.gz",
        ],
    )
